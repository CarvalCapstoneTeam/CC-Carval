...
return [
     ...
     */
    'title' => 'Carval API docs',

    /*
     * A short description of your API. Will be included in the docs webpage, Postman collection and OpenAPI spec.
     */
    'description' => 'Carval is an Android app designed to offer a reliable solution, our application addresses the challenges faced by job seekers dealing with fraudulent job listings. It has two main features: Detection your Job Vacancy (JOVA) and Article about Job and Carrer (ARCA). Here is the API documentation for the features in the Carval application, including authentication, articles, predictions, and more.',
    ...
    'auth' => [
         ...
         */
        'extra_info' => 'You can retrieve the token by accessing the <strong><a href="#endpoints-POSTapi-login">Login API</a></strong>.',
    ],
