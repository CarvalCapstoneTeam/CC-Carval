    ...
    return (() => {
        ...
        return (
            (() => {
                ...
                function r(t) {
                    return -1 === e().inArray(t.toLowerCase(), o)
                        ? "'".concat(t, "'")
                        : t;
                }
                var a,
                ...
                if (l) {
                    ...
                    c && (a = parseFloat(c[1])),
                        (c = /Trident\/.*rv:([0-9]{1,}[.0-9]{0,})/.exec(s)) &&
                            (a = parseFloat(c[1]));
                }
                var u = /Edge\/\d+/.test(s),
                    d =
                ...
                const f = {
                    ...
                    isFontInstalled: function (t) {
                        ...
                        return (
                            (o.font = "200px " + r(t) + ', "' + e + '"'),
                            n !== o.measureText("mmmmmmmmmmwwwww").width
                        );
                    },
                ...
                function j(t) {
                    ...
                    return (
                        0 === e ||
                        (!S(t) && 1 === e && t.innerHTML === M) ||
                        !(!y.all(t.childNodes, S) || "" !== t.innerHTML)
                    );
                }
                function U(t) {
                ...
                function et(t, e) {
                    ...
                    if (0 === t.offset) {
                        ...
                        tt(t.node)
                            ? (n = O((o = t.node.childNodes[t.offset - 1])))
                ...
                function ot(t, e) {
                    ...
                    if (O(t.node) === t.offset) {
                        ...
                        i
                            ? ((o = i), (n = 0))
                            : ((o = t.node.parentNode), (n = J(t.node) + 1));
                    } else
                        tt(t.node)
                            ? ((o = t.node.childNodes[t.offset]), (n = 0))
                            : ((o = t.node),
                              (n = e ? O(t.node) : t.offset + 1));
                    return { node: o, offset: n };
                }
                function nt(t, e) {
                    var o,
                    ...
                    if (O(t.node) === t.offset) {
                        ...
                        (o = t.node.parentNode),
                            (n = J(t.node) + 1),
                            C(o) && ((o = t.node.nextSibling), (n = 0));
                    } else if (tt(t.node)) {
                        if (((n = 0), j((o = t.node.childNodes[t.offset]))))
                            return j(t.node.nextSibling)
                                ? null
                                : { node: t.node.nextSibling, offset: n };
                    } else if (
                        ((o = t.node), (n = e ? O(t.node) : t.offset + 1), j(o))
                    )
                        return null;
                    return { node: o, offset: n };
                }
                ...
                function rt(t, e) {
                    ...
                    return (
                        _(a, V(r)),
                        o || (U(t.node), U(a)),
                        i && (j(t.node) && lt(t.node), j(a))
                            ? (lt(a), t.node.nextSibling)
                            : a
                    );
                }
                function at(t, e, o) {
                ...
                function lt(t, e) {
                    if (t && t.parentNode) {
                        ...
                        if (!e) {
                            for (
                                var n = [], i = 0, r = t.childNodes.length;
                                i < r;
                                i++
                            )
                ...
                const dt = {
                    ...
                    posFromPlaceholder: function (t) {
                        var o = e()(t),
                            n = o.offset(),
                            i = o.outerHeight(!0);
                        return { left: n.left, top: n.top + i };
                    },
                    ...
                    isCustomStyleTag: function (t) {
                        return (
                            t &&
                            !S(t) &&
                            y.contains(t.classList, "note-styletag")
                        );
                    },
                };
                function ht(t, e) {
                ...
                var ft = (function () {
                    function t(o, n) {
                        !(function (t, e) {
                            ...
                            (e().summernote.ui = e().summernote.ui_template(
                                this.options
                            )),
                            ...
                            },
                            {
                                ...
                                value: function () {
                                    ...
                                    Object.keys(this.modules)
                                        ...
                                        Object.keys(this.memos).forEach(
                                            function (e) {
                                                t.removeMemo(e);
                                            }
                                        ),
                    ...
                    var e = document.body.createTextRange(),
                        o = (function t(e, o) {
                            ...
                            if (dt.isText(e)) {
                                ...
                                (n = a || e.parentNode),
                                    (o += y.sum(y.tail(r), dt.nodeLength)),
                                    (i = !a);
                            } else {
                                if (((n = e.childNodes[o] || e), dt.isText(n)))
                                    return t(n, 0);
                                (o = 0), (i = !1);
                            }
                ...
                var gt = (function () {
                    function t(e, o, n, i) {
                        !(function (t, e) {
                            ...
                            (this.ec = n),
                            (this.eo = i),
                            (this.isOnEditable = this.makeIsOn(dt.isEditable)),
                            (this.isOnList = this.makeIsOn(dt.isList)),
                            (this.isOnAnchor = this.makeIsOn(dt.isAnchor)),
                            (this.isOnCell = this.makeIsOn(dt.isCell)),
                            (this.isOnData = this.makeIsOn(dt.isData));
                    }
                    var o, n, i;
                    return (
                        (o = t),
                        (n = [
                            ...
                            },
                            {
                                ...
                                value: function (t) {
                                    var o = e()(t).height();
                                    return (
                                        t.scrollTop + o < this.sc.offsetTop &&
                                ...
                                value: function () {
                                    var e = function (t, e) {
                                            ...
                                            if (
                                                dt.isVisiblePoint(t) &&
                                                (!dt.isEdgePoint(t) ||
                                                    (dt.isRightEdgePoint(t) &&
                                                        !e) ||
                                                    (dt.isLeftEdgePoint(t) &&
                                                        e) ||
                                                    (dt.isRightEdgePoint(t) &&
                                                        e &&
                                                        dt.isVoid(
                            ...
                            },
                            {
                                ...
                                value: function () {
                                    if (
                                        dt.isBodyContainer(this.sc) &&
                                        dt.isEmpty(this.sc)
                                    )
                                        return (
                                            (this.sc.innerHTML = dt.emptyPara),
                                            new t(
                                                this.sc.firstChild,
                                                0,
                                                this.sc.firstChild,
                                    ...
                                    var e,
                                        o = this.normalize();
                                    if (
                                        dt.isParaInline(this.sc) ||
                                        dt.isPara(this.sc)
                                    )
                                        return o;
                                    if (dt.isInline(o.sc)) {
                                        var n = dt.listAncestor(
                                            o.sc,
                                            m.not(dt.isInline)
                                        );
                                        (e = y.last(n)),
                            ...
                            },
                            {
                                ...
                                value: function (t) {
                                    ...
                                    return (
                                        o.rightNode
                                            ? (o.rightNode.parentNode.insertBefore(
                                                  t,
                                                  o.rightNode
                                              ),
                                              dt.isEmpty(o.rightNode) &&
                                                  dt.isPara(t) &&
                                                  o.rightNode.parentNode.removeChild(
                                                      o.rightNode
                                                  ))
                ...
                const bt = {
                    create: function (t, e, o, n) {
                        ...
                        if (2 === arguments.length)
                            return new gt(t, e, (o = t), (n = e));
                        var i = this.createFromSelection();
                        if (!i && 1 === arguments.length) {
                            var r = arguments[0];
                            return (
                                dt.isEditable(r) && (r = r.lastChild),
                                this.createFromBodyElement(
                                    r,
                                    dt.emptyPara === arguments[0].innerHTML
                                )
                            );
                        }
                        return i;
                    ...
                    createFromSelection: function () {
                        ...
                        if (f.isW3CRangeSupport) {
                            ...
                            var c = mt(l, !0),
                                u = mt(s, !1);
                            dt.isText(c.node) &&
                                dt.isLeftEdgePoint(c) &&
                                dt.isTextNode(u.node) &&
                                dt.isRightEdgePoint(u) &&
                    ...
                    createFromNode: function (t) {
                        ...
                        return (
                            dt.isVoid(e) &&
                                ((o = dt.listPrev(e).length - 1),
                                (e = e.parentNode)),
                            dt.isBR(n)
                                ? ((i = dt.listPrev(n).length - 1),
                                  (n = n.parentNode))
                                : dt.isVoid(n) &&
                                  ((i = dt.listPrev(n).length),
                                  (n = n.parentNode)),
                            this.create(e, o, n, i)
                        );
                    },
                ...
                const yt = {
                    ...
                    isMove: function (t) {
                        return y.contains(
                            [kt.LEFT, kt.UP, kt.RIGHT, kt.DOWN],
                            t
                        );
                    },
                    isNavigation: function (t) {
                        return y.contains(
                            [kt.HOME, kt.END, kt.PAGEUP, kt.PAGEDOWN],
                            t
                        );
                    },
                        ...
                        (n = [
                            ...
                            },
                            {
                                ...
                                value: function (t, o) {
                                    ...
                                    if (t.isCollapsed())
                                        return [t.insertNode(dt.create(n))];
                            ...
                            },
                            {
                                ...
                                value: function (t) {
                                    ...
                                    return (
                                        (n.anchor =
                                            t.isOnAnchor() &&
                                            dt.ancestor(t.sc, dt.isAnchor)),
                                        (n.ancestors = dt.listAncestor(
                                            t.sc,
                                            dt.isEditable
                                        )),
                                        (n.range = t),
                            ...
                            },
                            {
                                ...
                                value: function (t, e) {
                                    var o = y.head(t),
                                        n = y.last(t),
                                        i =
                                            dt.isList(o.previousSibling) &&
                                            o.previousSibling,
                                        r =
                                            dt.isList(n.nextSibling) &&
                                            n.nextSibling,
                                        a =
                                            i ||
                                            dt.insertAfter(
                                    ...
                                    return (
                                        (t = t.map(function (t) {
                                            return dt.isPurePara(t)
                                                ? dt.replace(t, "LI")
                                                : t;
                                        })),
                                        dt.appendChildNodes(a, t),
                                        r &&
                                            (dt.appendChildNodes(
                                                a,
                                                y.from(r.childNodes)
                        ...
                        (n = [
                            {
                                ...
                                value: function (t, e) {
                                    var o = dt.createText(
                                        new Array(e + 1).join(dt.NBSP_CHAR)
                                    );
                                    (t = t.deleteContents()).insertNode(o, !0),
                                        (t = bt.create(o, e)).select();
                                },
                            },
                            {
                                key: "insertParagraph",
                                value: function (t, o) {
                                    ...
                                    var n,
                                        i = dt.ancestor(o.sc, dt.isPara);
                                    if (i) {
                                        if (
                                            dt.isLi(i) &&
                                            (dt.isEmpty(i) ||
                                                dt.deepestChildIsEmpty(i))
                                        )
                    ...
                    (this.getActionList = function () {
                        ...
                        e &&
                            ...
                            e.parentElement &&
                                ...
                                "tr" ===
                                    e.parentElement.tagName.toLowerCase() &&
                ...
                (Pt.where = { Row: 0, Column: 1 }),
                    (Pt.requestAction = { Add: 0, Delete: 1 }),
                    (Pt.resultAction = {
                        Ignore: 0,
                        SubtractSpanCount: 1,
                        RemoveCell: 2,
                            ...
                            },
                            {
                                ...
                                value: function (t, o) {
                                    ...
                                    if ("top" === o) i.before(a);
                                        ...
                                        if (n.rowSpan > 1) {
                                            var f =
                                                i[0].rowIndex + (n.rowSpan - 2);
                                            return void e()(
                                                e()(i).parent().find("tr")[f]
                                            ).after(e()(a));
                                        }
                                        i.after(a);
                                    }
                            ...
                            },
                            {
                                ...
                                value: function (t, o, n) {
                                    for (var i, r = [], a = 0; a < t; a++)
                                        r.push("<td>" + dt.blank + "</td>");
                                    i = r.join("");
                                    for (var s, l = [], c = 0; c < o; c++)
                                        l.push("<tr>" + i + "</tr>");
                                    s = l.join("");
                ...
                var At = (function () {
                    function t(o) {
                        ...
                        !(function (t, e) {
                            ...
                            (this.context = o),
                            (this.$note = o.layoutInfo.note),
                            (this.$editor = o.layoutInfo.editor),
                            (this.$editable = o.layoutInfo.editable),
                            ...
                            (this.style = new St()),
                            (this.table = new Rt()),
                            (this.typing = new Nt(o)),
                            (this.bullet = new Et()),
                            (this.history = new Ct(o)),
                            this.context.memo(
                                "help.escape",
                        ...
                        (this.insertParagraph = this.wrapCommand(function () {
                            ...
                            (this.insertNode = this.wrapCommand(function (t) {
                                n.isLimited(e()(t).text().length) ||
                                    (n.getLastRange().insertNode(t),
                                    n.setLastRange(
                                        bt.createFromNodeAfter(t).select()
                                    ));
                            })),
                            (this.insertText = this.wrapCommand(function (t) {
                                if (!n.isLimited(t.length)) {
                                    var e = n
                                        .getLastRange()
                                        .insertNode(dt.createText(t));
                                    n.setLastRange(
                                        bt.create(e, dt.nodeLength(e)).select()
                                    );
                                }
                            })),
                            ...
                            (this.floatMe = this.wrapCommand(function (t) {
                                ...
                                o.toggleClass("note-float-left", "left" === t),
                                    o.toggleClass(
                                        "note-float-right",
                                        "right" === t
                                    ),
                                    o.css("float", "none" === t ? "" : t);
                            })),
                        ...
                        (n = [
                            {
                                ...
                                value: function () {
                                    ...
                                    this.$editable
                                        ...
                                        this.$editable.html(
                                            dt.html(this.$note) || dt.emptyPara
                                        ),
                                        this.$editable.on(
                                            f.inputEventName,
                                            m.debounce(function () {
                            ...
                            },
                            {
                                ...
                                value: function (t) {
                                    var e = bt
                                            .createFromNodeBefore(y.head(t))
                                            .getStartPoint(),
                                        o = bt
                                            .createFromNodeAfter(y.last(t))
                                            .getEndPoint();
                                    return bt.create(
                                        e.node,
                                        e.offset,
                            ...
                            },
                            {
                                ...
                                value: function (t) {
                                    t
                                        ? (this.lastRange = t)
                                        : ((this.lastRange = bt.create(
                                              this.editable
                                          )),
                                          0 ===
                                              e()(this.lastRange.sc).closest(
                                                  ".note-editable"
                                              ).length &&
                                              (this.lastRange =
                                                  bt.createFromBodyElement(
                                                      this.editable
                                                  )));
                                },
                            },
                            ...
                            },
                            {
                                ...
                                value: function (t) {
                                    ...
                                    e().each(t, function (t, n) {
                                        ...
                                        o.options.maximumImageFileSize < n.size
                            ...
                            },
                            {
                                key: "getLinkInfo",
                                value: function () {
                                    var t = this.getLastRange().expand(
                                            dt.isAnchor
                                        ),
                            ...
                            },
                            {
                                ...
                                value: function () {
                                    return (
                                        dt.isEmpty(this.$editable[0]) ||
                                        dt.emptyPara === this.$editable.html()
                                    );
                                },
                            },
                            {
                                        ...
                                        this.$dropzone
                                            .on("dragenter", function () {
                                                t.$dropzone.addClass("hover"),
                                                    n.text(
                                                        t.lang.image.dropImage
                                                    );
                                            })
                                            .on("dragleave", function () {
                                                t.$dropzone.removeClass(
                                                    "hover"
                                                ),
                                                    n.text(
                                                        t.lang.image
                ...
                var Wt = (function () {
                    function t(o) {
                        !(function (t, e) {
                            ...
                            (this.$statusbar = o.layoutInfo.statusbar),
                            (this.$editable = o.layoutInfo.editable),
                            (this.$codable = o.layoutInfo.codable),
                            (this.options = o.options);
                    }
                    var o, n, i;
                    return (
                ...
                var Vt = (function () {
                    function t(o) {
                        ...
                        !(function (t, e) {
                            ...
                            (this.context = o),
                            (this.$editor = o.layoutInfo.editor),
                            (this.$toolbar = o.layoutInfo.toolbar),
                            (this.$editable = o.layoutInfo.editable),
                            (this.$codable = o.layoutInfo.codable),
                ...
                var _t = (function () {
                    function t(o) {
                        ...
                        !(function (t, e) {
                            ...
                            (this.context = o),
                            (this.$document = e()(document)),
                            (this.$editingArea = o.layoutInfo.editingArea),
                            (this.options = o.options),
                            (this.lang = this.options.langInfo),
                            (this.events = {
                    ...
                    return (
                        ...
                        (o = [
                            ...
                            },
                            {
                                key: "handleKeyup",
                                value: function (t) {
                                    y.contains(this.keys, t.keyCode) &&
                                        this.replace();
                                },
                            },
                        ]) && Jt(e.prototype, o),
                ...
                var ie = (function () {
                    function t(o) {
                        !(function (t, e) {
                            ...
                            (this.options = o.options),
                            (this.lang = this.options.langInfo),
                            (this.invertedKeyMap = m.invertObject(
                                this.options.keyMap[f.isMac ? "mac" : "pc"]
                            ));
                    }
                    var o, n, i;
                    return (
                            ...
                            },
                            {
                                ...
                                value: function (t) {
                                    return (
                                        ...
                                        -1 === f.genericFontFamilies.indexOf(t)
                                    );
                                },
                            },
                            {
                            ...
                            },
                            {
                                ...
                                value: function (t) {
                                    var o = t || this.$toolbar,
                                        n = this.context.invoke(
                                            "editor.currentStyle"
                                        );
                                    if (
                                        (this.updateBtnStates(o, {
                ...
                var pe = (function () {
                    function t(o) {
                        ...
                        !(function (t, e) {
                            ...
                            (this.context = o),
                            (this.ui = e().summernote.ui),
                            (this.editable = o.layoutInfo.editable[0]),
                            (this.options = o.options),
                            (this.events = {
                                "summernote.disable summernote.dialog.shown":
                                    function () {
                        ...
                        (n = [
                            {
                                ...
                                value: function () {
                                    return (
                                        this.options.airMode &&
                                        !y.isEmpty(this.options.popover.air)
                                    );
                                },
                            },
                            {
                            ...
                            },
                            {
                                key: "update",
                                value: function (t) {
                                    var o = this.context.invoke(
                                        "editor.currentStyle"
                                    );
                                    if (
                                        !o.range ||
                                        (o.range.isCollapsed() && !t)
                                    )
                                        this.hide();
                                    else {
                                        var n = {
                        ...
                        (n = [
                                ...
                                value: function () {
                                    ...
                                    if (t.length) {
                                        ...
                                        if (
                                            ...
                                            n > 0 &&
                                                (this.lastWordRange.so += n);
                                        }
                                        if (
                                            (this.lastWordRange.insertNode(o),
                                            "next" === this.options.hintSelect)
                                        ) {
                                            var i = document.createTextNode("");
                                            e()(o).after(i),
                                                bt
                                                    .createFromNodeBefore(i)
                                                    .select();
                                        } else
                                            bt.createFromNodeAfter(o).select();
                                        (this.lastWordRange = null),
                                            this.hide(),
                                ...
                                value: function (t) {
                                    this.$popover.is(":visible") &&
                                        (t.keyCode === yt.code.ENTER
                                            ? (t.preventDefault(),
                                              this.replace())
                                            : t.keyCode === yt.code.UP
                                            ? (t.preventDefault(),
                                              this.moveUp())
                                            : t.keyCode === yt.code.DOWN &&
                                              (t.preventDefault(),
                                              this.moveDown()));
                                },
                            },
                            ...
                            },
                            {
                                ...
                                value: function (t, o) {
                                    ...
                                    return (
                                        this.searchKeyword(t, o, function (e) {
                                            (e = e || []).length &&
                                                (i.html(
                        ...
                        (n = [
                            {
                                ...
                                value: function (t) {
                                    ...
                                    return (
                                        this.callback &&
                                            this.callback(o, this.options),
                                        this.options &&
                                            this.options.callback &&
                                            this.options.callback(o),
                                        t && t.append(o),
                                        o
                                    );
                                },
                ...
                const Ne = function (t, e) {
                    return function () {
                        var o =
                                "object" === Te(arguments[1])
                                    ? arguments[1]
                                    : arguments[0],
                            n = Array.isArray(arguments[0]) ? arguments[0] : [];
                        return (
                            o && o.children && (n = o.children),
                            new $e(t, n, o, e)
                        );
                    };
                };
                                ...
                                value: function () {
                                    ...
                                    var i = this.$tooltip,
                                        ...
                                        a =
                                            ...
                                            t.data("placement");
                                    i.addClass(a),
                                        i.find(".note-tooltip-content").text(r),
                                        i.appendTo(this.options.target);
                                    var s = t.outerWidth(),
                                        l = t.outerHeight(),
                                        c = i.outerWidth(),
                                        u = i.outerHeight();
                ...
                e()(document).on("click", function (t) {
                    e()(t.target).closest(".note-btn-group").length ||
                        (e()(".note-btn-group.open").removeClass("open"),
                        e()(".note-btn-group .note-btn.active").removeClass(
                            "active"
                        ));
                }),
                ...
                var He = Ne('<div class="note-editor note-frame"></div>'),
                    ...
                    Ve = Ne(
                        ...
                        function (t, o) {
                            o &&
                                ...
                                o.contents && t.html(o.contents),
                                o &&
                                    o.data &&
                                    "dropdown" === o.data.toggle &&
                                    t.data(
                                        "_lite_dropdown",
                                        new Ae(t, { container: o.container })
                                    ),
                                o &&
                                    o.codeviewKeepButton &&
                    ...
                    qe = Ne(
                        ...
                        function (t, o) {
                            var n = Array.isArray(o.items)
                                ...
                                : o.items;
                            t.html(n).attr({ "aria-label": o.title }),
                                t.on(
                                    "click",
                                    "> .note-dropdown-item",
                                    function (t) {
                                    ...
                                    o.find(
                                        ...
                                        .mousemove(function (o) {
                                            !(function (t, o, n) {
                                                ...
                                                } else i = { x: t.offsetX, y: t.offsetY };
                                                var d =
                                                        Math.ceil(i.x / 18) ||
                                                        1,
                                                    h =
                    ...
                    ro = Ne(
                        ...
                        function (t, e) {
                            var o =
                                void 0 !== e.direction ? e.direction : "bottom";
                            t.addClass(o).hide(),
                                e.hideArrow &&
                                    t.find(".note-popover-arrow").hide();
                        }
                    ),
