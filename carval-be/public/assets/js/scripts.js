            ...
            $(elm).each(function () {
                ...
                var def = {
                        ...
                        language: {
                            ...
                            lengthMenu:
                                "<span class='d-none d-sm-inline-block'>Tampilkan</span><div class='form-control-select'> _MENU_ </div><span class='d-none d-sm-inline-block'>data</span>",
    ...
    NioApp.BS.ddfix = function (elm, exc) {
        ...
        if (NioApp.State.isRTL) {
            ...
            $dMenu.each(function () {
                ...
                if (
                    $self.hasClass("dropdown-menu-end") &&
